...
python3 A-Team/RMC.py A-Team/manifests/default.xml A-Team/manifests/aicp.xml A-Team/manifests/crowdin.xml A-Team/manifests/lineage.xml A-Team/manifests/remove.xml A-Team/local_manifests/moto-common.xml A-Team/local_manifests/a-aicp.xml
